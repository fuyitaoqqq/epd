...
public class ResultDto {
	...
	public static ResultDto success(Object data) {
		return new ResultDto(ResultConstants.SUCCESS.getCode(), ResultConstants.SUCCESS.getMsg(), data);
	}

	public static ResultDto success() {
		return new ResultDto(ResultConstants.SUCCESS.getCode(), ResultConstants.SUCCESS.getMsg(), null);
	}
